package com.example.anhthu.drawerlayout;
...
import com.example.anhthu.drawerlayout.R;

public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {
    private WebView wbKenh14;
    private WebView wbBongdaPlus;
...
//        wbKenh14.getSettings().setJavaScriptEnabled(true);
        ...
        wbBongdaPlus = (WebView)findViewById(R.id.url_bongdaplus);
        wbBongdaPlus.setWebViewClient(new WebViewClient());
        wbBongdaPlus.loadUrl("http://bongdaplus.vn/");
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            if (wbBongdaPlus.canGoBack() == true) {
                wbBongdaPlus.goBack();
                return true;
                }
